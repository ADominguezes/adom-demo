...
gulp.task('styles-replace', ['styles'], function () {
    return gulp.src('./adom-demo-styles.html')
        .pipe(replace(/<style>[^>]*<\/style>/, function (s) {
            var style = fs.readFileSync('./dist/css/adom-demo.css', 'utf8');
            return '<style>\n' + style + '\n</style>';
        }))
        .pipe(gulp.dest('./'))
        .pipe(browserSync.stream());
...
/* ======================================================================================================
* watch changes in files adom-demo.scss and adom-demo.html
* ======================================================================================================*/
gulp.task('watch', function () {
    gulp.watch('./adom-demo.html', ['styles-replace']); // Vigila cambios en el html
    gulp.watch('./dist/css/adom-demo.css', ['styles-replace']); // Vigila cambios en el html
